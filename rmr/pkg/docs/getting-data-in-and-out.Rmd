...
Now lets put this file into the hdfs:
```{r getting-data.hdfs.put.fwf.data}
```

Define `fields` as a list containing the field names, start byte location, and end byte location:
